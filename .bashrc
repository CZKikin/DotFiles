...
#One line aliases
alias cls='clear'
alias router='ssh minirouter@192.168.42.1'
alias tracert='traceroute'
alias what='echo "I AM gROOT :3"'
alias lla='ls -la'
alias qq='shutdown now'
alias bashrc='sudo vim ~/.bashrc'
alias vimrc='sudo vim ~/.vimrc'
alias i3rc='sudo vim ~/.config/i3/config'
alias ..='cd ..'
alias q='exit'
alias py='python3'
alias ree='reboot'
alias dupg="sudo apt dist-upgrade"
alias doup='sudo apt clean; sudo apt update; sudo apt upgrade'
