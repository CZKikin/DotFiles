...
sudo pacman -S freetype2 pkg-config xorg xorg-server xorg-xinit xrandr pavucontrol pulseaudio networkmanager unclutter neomutt picom discord network-manager-applet texlive-most ranger arandr feh gcc pandoc net-tools xclip 
